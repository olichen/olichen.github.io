...
svcPanel.querySelectorAll('.svc-option').forEach(opt => {
  opt.addEventListener('click', async () => {
    ...
    const datasetMap = { spring2024: Dataset.Spring2024, fall2024: Dataset.Fall2024, spring2025: Dataset.Spring2025, fall2025: Dataset.Fall2025 };
...
function initUIFromOptions() {
  ...
  const datasetLabelMap = { [Dataset.Spring2024]: 'Spring 2024', [Dataset.Fall2024]: 'Fall 2024', [Dataset.Spring2025]: 'Spring 2025', [Dataset.Fall2025]: 'Fall 2025' };
  const datasetValueMap = { [Dataset.Spring2024]: 'spring2024', [Dataset.Fall2024]: 'fall2024', [Dataset.Spring2025]: 'spring2025', [Dataset.Fall2025]: 'fall2025' };
