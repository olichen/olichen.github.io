...
export class StopData {
  ...
  static async createInstance() {
    const stopData = d3.csvParse(await FileAttachment("../data/stops.txt").text(), d3.autoType)
    const riderData = d3.csvParse(await FileAttachment("../data/ridership-spring-2024.csv").text(), d3.autoType);
